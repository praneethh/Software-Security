...
<c:if test="${not empty error}">
	...
	<center>
		<form:form method="POST" commandName="MerchantSignUp" 
			action="externalRegisterationAction">
													...
													<tbody>
														...
														<tr>
															<td style="color: white"><form:label path="uname">
																	<spring:message code="label.merchantusername" />
																</form:label></td>
														...
														<tr>
															<td style="color: white"><form:label path="email">
																	<spring:message code="label.companyemail" />
																</form:label></td>
														...
														<tr>
															<td style="color: white"><form:label path="phoneno">
																	<spring:message code="label.companyphone" />
																</form:label></td>
														...
														<tr>
															<td style="color: white"><form:label path="ssn">
																	<spring:message code="label.companyRegNo" />
																</form:label></td>
...
"6LeHaP0SAAAAALdnTmrUmOH4BBvrWEt8KfBFZYrQ", false);
